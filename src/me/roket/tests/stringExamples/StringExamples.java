...
public class StringExamples {
    public static void main(String[] args) {
        ...
        System.out.printf("%s,%s%n", string1.hashCode(), string2.hashCode());
        ...
        System.out.printf("%s,%s%n", string3.hashCode(), string4.hashCode());
        System.out.println(string3 == string4); // false
        System.out.println(string3.equals(string4)); //true

        // 이때, 위 연산에서 ==는 문자열을 비교하는 것이 아닌 변수의 주소값을 비교한다.
        // 또한, .hashCode() 메서드는 문자열 내용에 기반해 할당되는 유일한 코드값으로, 내용이 같다면 코드도 동일하다.
    }
}
